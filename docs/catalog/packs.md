...
| --- | --- | --- | --- | --- | --- | --- |
| [agentic-issue-delivery](../../packs/agentic-issue-delivery/README.md) | role-pack | 0.16.0 | experimental | workflow, coding, review | 13 skills, 6 agents, 2 hooks | Workflow pack for turning design-stage work into implementation-ready issues, then executing those issues through subagent-driven review and delivery gates. |
