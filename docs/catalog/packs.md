...
| [codebase-stewardship](../../packs/codebase-stewardship/README.md) | role-pack | 0.6.0 | experimental | coding, refactoring, review | 8 skills, 1 agents, 1 hooks | 周期性/按需的代码健康治理：深化模块、治乱删冗、定架构方向，共用 grill 对抗式对话与 openspec/glossary.md + docs/adr/ 领域沉淀。区别于 agentic-issue-delivery 的一次性 issue 交付流水线。 |
