...
- Write tests in vertical slices at pre-agreed public seams, with expected values from an independent source of truth; mock only at system boundaries, and leave refactoring to the review stage.
