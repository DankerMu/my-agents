...
- Never run test suites, verification-matrix rows, or CI-equivalent commands; adjudicate from the supplied verification evidence and, when it cannot settle a candidate, name the exact verification gap in the note instead of executing it.
