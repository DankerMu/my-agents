...
name: issue-solver
description: >
  Solves a single GitHub issue end-to-end by orchestrating specialist agents through triage, implementation, review, and merge.
tools: read, grep, glob, bash, task
spawns: triager, planner, coder, reviewer, debugger, splitter
---
