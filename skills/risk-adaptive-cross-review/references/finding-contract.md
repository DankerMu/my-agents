...
- **`subagent-workflow` evidence vocabulary**: P0 → `critical`, P1 → `major`,
  P2 → `minor`; Note is non-actionable and never blocks a round. This mapping
  is canonical here; the workflow's references point at it rather than
  restating it.
