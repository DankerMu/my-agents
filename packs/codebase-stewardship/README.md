...
- 与 `agentic-issue-delivery` **刻意重叠**：`entropy-review`、`repo-entropy-audit`、`future-aware-architecture`、`grill-me` 同时服务交付流水线（作支撑）与本包（作核心）。skill 在 my-agents 里是引用而非拷贝，重叠维护成本≈0。
